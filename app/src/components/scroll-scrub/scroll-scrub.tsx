...
function renderCaption(scene: ScrollScrubScene, index: number) {
  ...
  return (
    ...
    >
      <div className="scroll-scrub__stage">
        ...
        {pinnedCaptions ? (
          <div className="scroll-scrub__pinned-captions">
            {scenes.map((scene, index) => (
              <div key={scene.id} className="scroll-scrub__caption" data-active={activeSection === index} aria-hidden={activeSection !== index} inert={activeSection !== index}>
                {renderCaption(scene, index)}
              </div>
            ))}
          </div>
        ) : null}
        ...
        {segments.map((segment) => {
          ...
          return (
            <article
              ...
              style={bandStyle}
            >
              {pinnedCaptions ? null : renderCaption(scene, segment.sectionIndex)}
            </article>
          );
        })}
      </div>
