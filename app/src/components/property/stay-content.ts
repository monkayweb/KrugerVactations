export const houseAmenities = ["Air conditioning", "Fully equipped kitchen", "Dining area", "Smart TV", "Free Wi-Fi", "Parking", "Private patio", "Braai / BBQ area"];
export const estateAmenities = ["Swimming pools", "Restaurant and bar", "9-hole golf course", "Tennis courts and equipment", "Mini golf", "Children’s play area", "24-hour reception", "Gardens and estate grounds"];
